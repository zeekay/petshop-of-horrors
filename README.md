...
Every attack vector has been disabled. The malicious code is preserved as comments with detailed annotations. The git history tells the full story: the [initial commit](https://github.com/zeekay/petshop-malware-forensics/commit/HEAD~5) contains the original malicious code, and four subsequent merge commits each neutralize one attack vector with full forensic commentary.
...
**Pull Request: [#1](https://github.com/zeekay/petshop-malware-forensics/pull/1)**
...
**Pull Request: [#2](https://github.com/zeekay/petshop-malware-forensics/pull/2)**
...
**Pull Request: [#3](https://github.com/zeekay/petshop-malware-forensics/pull/3)**
...
**File: `package.json`**
**Trigger: `npm install`**
**Pull Request: [#4](https://github.com/zeekay/petshop-malware-forensics/pull/4)**
...
|---|----|----|---------|---------|
| 1 | [#1](https://github.com/zeekay/petshop-malware-forensics/pull/1) | VSCode Auto-Run Task | Open folder | Silent, invisible, auto-executes |
| 2 | [#2](https://github.com/zeekay/petshop-malware-forensics/pull/2) | Fake Font RCE Dropper | Via Vector 1 | Disguised as .woff2 font file |
| 3 | [#3](https://github.com/zeekay/petshop-malware-forensics/pull/3) | Bootstrap RCE Backdoor | Server start | Base64-encoded C2 in .env |
| 4 | [#4](https://github.com/zeekay/petshop-malware-forensics/pull/4) | npm Postinstall Hook | `npm install` | 6 layers of indirection |
...
```bash
git clone https://github.com/zeekay/petshop-malware-forensics
...
*The original malicious code is preserved in the [initial commit](https://github.com/zeekay/petshop-malware-forensics/commit/HEAD~5). Each subsequent merge commit neutralizes one attack vector.*
